...
class DB {
  // initial connection
  public static $dbName = 'halokis';
  public static $user = 'root';
  public static $password = 'gautam11';
...
class MeekroDB {
  // initial connection
  public $dbName = 'halokis';
  public $user = 'root';
  public $password = 'gautam11';
  ...
  public function insert($table, $data) { echo "<br>01";return $this->insertOrReplace('INSERT', $table, $data); }
